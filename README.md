...
To use Jasmine to write and run a number of tests against a pre-existing application successfully. These will test the underlying business logic of the application as well as the event handling and DOM manipulation. 
