...
To use Jasmine to write and run a number of tests against a pre-existing application successfully for behavior-driven development an extension of TDD that is more user focused. These will test the underlying business logic of the application as well as the event handling and DOM manipulation. I had fun using ES6 arrow functions syntax () => {} during this project.
